...
import org.springframework.data.jpa.repository.Modifying; // Importante para UPDATEs
...
public interface AlumnoRepository extends JpaRepository<Alumno, Long> {
    ...
    @Query("UPDATE Alumno a SET a.turnoComedor = 'No' WHERE a.id > 0") // <--- El "WHERE a.id > 0" engaña al modo seguro de MySQL
